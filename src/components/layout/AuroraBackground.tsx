    ...
    <div className="aurora-bg" aria-hidden="true">
      <div
        ...
        style={{
          ...
          maxWidth: 640,
          maxHeight: 640,
          background: 'radial-gradient(circle, rgba(79,124,255,0.24) 0%, transparent 70%)',
        }}
      />
      <div
        className={`aurora-blob ${reduced ? '' : 'animate-drift'}`}
        style={{
          ...
          maxWidth: 700,
          maxHeight: 700,
          background: 'radial-gradient(circle, rgba(123,97,255,0.19) 0%, transparent 70%)',
          animationDelay: '-5s',
        }}
      />
      <div
        ...
        style={{
          ...
          maxWidth: 560,
          maxHeight: 560,
          background: 'radial-gradient(circle, rgba(0,212,255,0.19) 0%, transparent 70%)',
          animationDelay: '-10s',
        }}
      />
    </div>
